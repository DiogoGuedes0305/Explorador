...
export default class ThumbRaiser {
    constructor(generalParameters, audioParameters, cubeTexturesParameters, mazeParameters, 
        playerParameters, ambientLightParameters, directionalLightParameters, spotLightParameters, 
        flashLightParameters, shadowsParameters, fogParameters, collisionDetectionParameters, 
        fixedViewCameraParameters, firstPersonViewCameraParameters, thirdPersonViewCameraParameters, 
        ...
        // this.labelRenderer.domE1ement.sty1e.position = 'absolute' ;
        // this.labelRenderer.domE1ement.sty1e.top = ' epx' ;
        ...
        this.visibleViewportCameras = [
            this.fixedViewCamera, this.firstPersonViewCamera, 
            this.thirdPersonViewCamera, this.topViewCamera];
    ...
    changeMaze(newMazeUrl) {
        ...
        this.maze = newMaze;
        this.changeBuildingNameLable(newMazeUrl)
        this.update()
    }
    ...
    update() {
        if (!this.gameRunning) {
                ...
                types.forEach(type => {
                    type.forEach(clip => {
                        ...
                        if (position.length == 4 && position[0] == "scene") { // Positional audio object (scene specific position in cartesian coordinates)
                            ...
                            clip.source.position.set(this.maze.exitLocation2.x, this.maze.exitLocation2.y, this.maze.exitLocation2.z);
                            clip.source.position.set(this.maze.exitLocation3.x, this.maze.exitLocation3.y, this.maze.exitLocation3.z);
                        }
            ...
            if (!this.animations.actionInProgress) {
                ...
                // Check if the player found the passage 1
                if (this.maze.foundExit1(this.player.position)) {
                    if(this.maze.url == "./buildings/A_Floor2.json"){
                        this.changeMaze("B_Floor2.json")
                    }else if(this.maze.url == "./buildings/B_Floor2.json"){
                        this.changeMaze("A_Floor2.json")
                    }else if(this.maze.url == "./buildings/C_Floor3.json"){
                        this.changeMaze("B_Floor2.json")
                    }else if(this.maze.url == "./buildings/D_Floor3.json"){
                        this.changeMaze("B_Floor2.json")
                    }else if(this.maze.url == "./buildings/B_Floor3.json"){
                        this.changeMaze("C_Floor4.json")
                    }else if(this.maze.url == "./buildings/C_Floor4.json"){
                        this.changeMaze("B_Floor3.json")
                    }else if(this.maze.url == "./buildings/C_Floor2.json"){
                        this.changeMaze("D_Floor2.json")
                    }else if(this.maze.url == "./buildings/D_Floor2.json"){
                        this.changeMaze("C_Floor2.json")
                    }
                // Check if the player found the passage 2
                }else if (this.maze.foundExit2(this.player.position)) {
                    if(this.maze.url == "./buildings/B_Floor2.json"){
                        this.changeMaze("C_Floor3.json")
                    }else if(this.maze.url == "./buildings/C_Floor3.json"){
                        this.changeMaze("D_Floor3.json")
                    }else if(this.maze.url == "./buildings/D_Floor3.json"){
                        this.changeMaze("C_Floor3.json")
                    }
                // Check if the player found the passage 3
                }else if (this.maze.foundExit3(this.player.position)) {
                    if(this.maze.url == "./buildings/B_Floor2.json"){
                        this.changeMaze("D_Floor3.json")
                    }
                }
                    ...
                    if (this.maze.enteredElevator(this.player.position)) {
                        ...
                        // Torna o container A visível
                        if(this.maze.url == "./buildings/A_Floor1.json" || this.maze.url == "./buildings/A_Floor2.json"){
                            document.getElementById('buttonContainerA').style.display = 'flex'; 
                        }
                        // Torna o container B visível
                        else if(this.maze.url == "./buildings/B_Floor1.json" || this.maze.url == "./buildings/B_Floor2.json"
                                || this.maze.url == "./buildings/B_Floor3.json"){
                            document.getElementById('buttonContainerB').style.display = 'flex'; 
                        }
                        // Torna o container C visível
                        else if(this.maze.url == "./buildings/C_Floor1.json" || this.maze.url == "./buildings/C_Floor2.json" 
                                || this.maze.url == "./buildings/C_Floor3.json"|| this.maze.url == "./buildings/C_Floor4.json"){
                            document.getElementById('buttonContainerC').style.display = 'flex';
                        }
                        // Torna o container D visível
                        else {
                            document.getElementById('buttonContainerD').style.display = 'flex';
                        }
                    }
            ...
            if (this.miniMapCamera.checkBox.checked) {
                ...
                this.renderer.render(this.frame, this.camera2D); // Render the frame
                // this.lableRenderer.render(this.frame, this.camera2D); // Render the frame
            }
        }
    }

    changeBuildingNameLable(building){
        if(building == "A_Floor1.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício A - Piso 1";
        }else if(building == "A_Floor2.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício A - Piso 2";
        }else if(building == "B_Floor1.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício B - Piso 1";
        }else if(building == "B_Floor2.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício B - Piso 2";
        }else if(building == "B_Floor3.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício B - Piso 3";
        }else if(building == "C_Floor1.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício C - Piso 1";
        }else if(building == "C_Floor2.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício C - Piso 2";
        }else if(building == "C_Floor3.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício C - Piso 3";
        }else if(building == "C_Floor4.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício C - Piso 4";
        }else if(building == "D_Floor1.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício D - Piso 1";
        }else if(building == "D_Floor2.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício D - Piso 2";
        }else if(building == "D_Floor3.json"){
            document.getElementById('buildingNameLable').innerHTML ="Edifício D - Piso 3";
        }
